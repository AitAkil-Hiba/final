...
import 'gestion_notifications_page.dart';
...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  final List<String> _filters = ['Tout', 'Activité', 'Avis'];
  ...
  List<Map<String, dynamic>> get _filteredNotifications {
    ...
    return _allNotifications.where((n) {
      ...
      //  Les notifications restent toujours visibles dans l'app
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const GestionNotificationsPage(),
                      ),
                    ),
                    child: Text(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Center(
              child: notif['initials'] != null
                  ? Text(
                      notif['initials'] as String,
